...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_MESSAGE_SOURCE_NODE_ID = "source_node_id";
    public static final String COLUMN_MESSAGE_DEST_NODE_ID = "dest_node_id";
    ...
    private static final String CREATE_TABLE_MESSAGES = "CREATE TABLE " + TABLE_MESSAGES +
            ...
            COLUMN_MESSAGE_SOURCE_NODE_ID + " TEXT NOT NULL, " +
            COLUMN_MESSAGE_DEST_NODE_ID + " TEXT NOT NULL, " +
            COLUMN_MESSAGE_TIMESTAMP + " INTEGER NOT NULL);";

    // TODO: Add mesh schema here later
